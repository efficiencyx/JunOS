# You can swap the base image, so this one Dockerfile builds for
# CPU and NVIDIA with the pinned Ollama release, or its matching
# ROCm build. start.sh and the compose overlays set it, the
