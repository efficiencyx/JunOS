...
**A tiny privacy note:** nothing phones home. Jun has no telemetry, no analytics and no collector to send anything to - your account, your chats, her memory and every setting stay in the database on your machine. The only thing that can leave is what you deliberately send to a hosted AI provider if you pick one. The details are in the [privacy notice](webapp/privacy.html). 🌸

**Hosting Jun for other people?** Then heads up: the moment someone other than you has an account on your install, their chats live on *your* box and *you're* the one responsible for them, not us. Keep the machine and its backups encrypted, don't hand the database to anyone, and if your local law wants you to tell your users what you store, tell them - [`webapp/privacy.html`](webapp/privacy.html) is a starting point you can edit. 🗂️

**And if you're in the EU:** hosting Jun for other people also makes you a *deployer* under the AI Act, whose art. 50 transparency duties started 2 August 2026. Jun ships the disclosure side already - the age gate says outright that she's an AI, there's a permanent `AI` badge in the header, and generated speech carries provenance metadata marking it artificial. Don't strip those out of your fork, and if you re-skin her as something that isn't obviously a bot, put the disclosure back yourself. The [privacy notice](webapp/privacy.html#ai-system) has the plain-language version. 🇪🇺
